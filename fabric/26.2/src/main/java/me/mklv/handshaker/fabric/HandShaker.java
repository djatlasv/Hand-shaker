...
public class HandShaker implements ClientModInitializer {
	...
	public static final Identifier MODS_CHANNEL = Identifier.fromNamespaceAndPath(MOD_ID, "mods");
	public static final Identifier INTEGRITY_CHANNEL = Identifier.fromNamespaceAndPath(MOD_ID, "integrity");
	...
	public void onInitializeClient() {
		...
		PayloadTypeRegistry.serverboundPlay().register(ModsListPayload.ID, ModsListPayload.CODEC);
		PayloadTypeRegistry.serverboundPlay().register(IntegrityPayload.ID, IntegrityPayload.CODEC);
	...
	public record ModsListPayload(String mods, String modListHash, String nonce, String fingerprint) implements CustomPacketPayload {
		public static final CustomPacketPayload.Type<ModsListPayload> ID = new CustomPacketPayload.Type<>(MODS_CHANNEL);
		public static final StreamCodec<FriendlyByteBuf, ModsListPayload> CODEC = StreamCodec.ofMember(
				(payload, buf) -> {
	...
	public record IntegrityPayload(byte[] signature, String jarHash, String nonce) implements CustomPacketPayload {
		public static final CustomPacketPayload.Type<IntegrityPayload> ID = new CustomPacketPayload.Type<>(INTEGRITY_CHANNEL);
		public static final StreamCodec<FriendlyByteBuf, IntegrityPayload> CODEC = StreamCodec.composite(
